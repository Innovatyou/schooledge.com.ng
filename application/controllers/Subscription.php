   ...
   public function checkout()
    ...
    public function payumoney_success()
    {
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            if (empty($params) || !$this->payment_callback_verifier->payumoney($this->input->post(), $config['payumoney_salt'], $params['txn_id'], $params['amount'])) show_error('Invalid payment callback', 400);
            // null session data
            $this->session->set_userdata("params", "");
