...
<?php if (get_permission('id_card_templete', 'is_add')): ?>
			<div class="tab-pane" id="add">
					...
					<?php
						$idCardStarters = array_filter(starter_templates(), function ($t) { return $t['applies_to'] == 'id_card'; });
						echo $this->load->view('partials/starter_template_picker', array('starters' => $idCardStarters, 'target' => 'card'), true);
					?>
					<?php if (is_superadmin_loggedin()): ?>
