...
class MembershipSwitcherPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MembershipSwitcherPage> createState() =>
      _MembershipSwitcherPageState();
}

class _MembershipSwitcherPageState
    extends ConsumerState<MembershipSwitcherPage> {
  int? _switchingId;
    ...
    try {
      ...
      if (mounted) {
        ...
        final message = data is Map && data['error'] is Map
            ? ((data['error'] as Map)['message'] ?? 'Could not switch school.')
                  .toString()
